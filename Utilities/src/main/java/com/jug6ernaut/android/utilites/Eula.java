 ...
 * using the application. Your application should call {@link com.jug6ernaut.android.utilites.Eula#show(android.app.Activity)}
...
public class Eula {
    ...
    public static boolean showLicense(final Activity activity) {
