package com.jug6ernaut.android.utilites.lazyloader;
...
public class ImageLoader {
    ...
    private Bitmap getBitmap(String url) 
    {
        ...
        //from SD cache
        System.out.println("Decode: " + f.getPath());
        ...
        //from shared
        try {
        	Drawable drawable = ImagesUtils.grabImageFromUrl(url);
        	Bitmap bitmap = ImagesUtils.drawableToBitmap(drawable);
        	/*
            Bitmap bitmap=null;
